...
oProject.SaveAs("C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS/1.aedt", True)
oProject.Rename("C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS/1.aedt", True)
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_1.2_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 2", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_1.2_L_10.9.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 3", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_1.2_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 4", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_1.2_L_30.3.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 5", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_1.2_L_40.0.csv")
...
oModule.CreateReport("Data Table 6", "Matrix", "Data Table", "Setup1 : Sweep1",
	...
	[
        ...
        "Width:="		, ["10.9 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
        "Length:="		, ["1.2 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
	],
	[
		"X Component:="		, "Freq",
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 6", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_10.9_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 7", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_10.9_L_10.9.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 8", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_10.9_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 9", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_10.9_L_30.3.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 10", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_10.9_L_40.0.csv")
...
oModule.CreateReport("Data Table 11", "Matrix", "Data Table", "Setup1 : Sweep1",
	...
	[
        ...
        "Width:="		, ["20.6 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
        "Length:="		, ["1.2 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
	],
	[
		"X Component:="		, "Freq",
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 11", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_20.6_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 12", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_20.6_L_10.9.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 13", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_20.6_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 14", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_20.6_L_30.3.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 15", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_20.6_L_40.0.csv")
...
oModule.CreateReport("Data Table 16", "Matrix", "Data Table", "Setup1 : Sweep1",
	...
	[
        ...
        "Width:="		, ["30.3 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
        "Length:="		, ["1.2 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
	],
	[
		"X Component:="		, "Freq",
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 16", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_30.3_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 17", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_30.3_L_10.9.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 18", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_30.3_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 19", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_30.3_L_30.3.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 20", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_30.3_L_40.0.csv")
...
oModule.CreateReport("Data Table 21", "Matrix", "Data Table", "Setup1 : Sweep1",
	...
	[
        ...
        "Width:="		, ["40.0 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
        "Length:="		, ["1.2 mm"], # 0: Name,  1: Value: 'All', 'Nominal' or 'Value+Unit' 
	],
	[
		"X Component:="		, "Freq",
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 21", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_40.0_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 22", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_40.0_L_10.9.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 23", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_40.0_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 24", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_40.0_L_30.3.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 25", "C:\PowerSynth_git\Master_for_danfoss\PowerCAD-full\export_data\workspace\RS//1_W_40.0_L_40.0.csv")
