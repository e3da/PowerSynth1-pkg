...
# This script will initialize a new project with one initial design
    ...
    # 4 : project_path
# New Project here
# User Name: qmle ,Script built on: 2017-05-26 09:00:57.170000
import sys
...
oProject.SaveAs("C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS/centercomporsite.aedt", True)
oProject.Rename("C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS/centercomporsite.aedt", True)
oProject = oDesktop.SetActiveProject("centercomporsite")
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_1.2_L_10.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_40.0_L_10.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_1.2_L_40.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_40.0_L_40.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_1.2_L_25.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_40.0_L_25.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_20.6_L_10.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//centercomporsite_W_20.6_L_40.0.csv")
