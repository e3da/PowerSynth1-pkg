...
# This script will initialize a new project with one initial design
    ...
    # 4 : project_path
# New Project here
# User Name: qmle ,Script built on: 2017-05-24 16:33:27.285000
import sys
...
oProject.SaveAs("C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS/Stack1.aedt", True)
oProject.Rename("C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS/Stack1.aedt", True)
oProject = oDesktop.SetActiveProject("Stack1")
...
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_1.2_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_40.0_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_1.2_L_40.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_40.0_L_40.0.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_1.2_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_40.0_L_20.6.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_20.6_L_1.2.csv")
...
# 0: data_name in Q3d, 1: data output path
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Data Table 1", "C:\PowerSynth_git\Response_Surface\PowerCAD-full\export_data\workspace\RS//Stack1_W_20.6_L_40.0.csv")
